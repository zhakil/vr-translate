...
public class UIManager : MonoBehaviour
{
    ...
    {
        if (targetLanguageInput != null && configManager != null)
            targetLanguageInput.onEndEdit.AddListener(configManager.SetTargetLanguage);

        if (gazeTimeSlider != null && configManager != null)
        {
        ...
        if (gazeStabilitySlider != null && configManager != null)
        {
